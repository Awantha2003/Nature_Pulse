...
// @route   POST /api/payments/demo-payment
// @desc    Process demo payment for appointments
// @access  Private
router.post('/demo-payment', protect, checkActive, async (req, res) => {
  try {
    ...
    try {
      await NotificationService.createNotification({
        ...
        message: `Your payment of LKR ${amount} for appointment with Dr. ${appointment.doctor.name} has been processed successfully.`,
        data: {
